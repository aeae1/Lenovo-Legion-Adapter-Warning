...
Open START-HERE.md in a text editor for the short instructions.

For the first laptop test, copy only the CONTENTS of 01_DIAGNOSTIC_USB
to a FAT32 USB, use the Lenovo Lenovo charger, disable Secure Boot
...
This package is for the Legion 5 Pro 16ACH6H / 82JQ with GKCN65WW.
It is tested in simulation and emulation, not on your laptop yet.
